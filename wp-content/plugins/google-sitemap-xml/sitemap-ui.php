...
HTML;
		...
		if(!$snl) {
			...
			if(isset($_GET['sm_donated']) || ($this->sg->GetOption('i_donated')===true && $this->sg->GetOption('i_hide_donated')!==true)) {
				?>
				<div class="updated">
					<strong><p><?php _e('Thank you very much for your coffee. You help me to continue support and development of this plugin and other free software!','sitemap'); ?> <a href="<?php echo $this->sg->GetBackLink() . "&amp;sm_hidedonate=true"; ?>"><small style="font-weight:normal;"><?php _e('Hide this notice', 'sitemap'); ?></small></a></p></strong>
				</div>
				<?php
				...
				?>
				<div class="updated">
					<strong><p><?php echo str_replace("%s",$this->sg->GetRedirectLink("buymecoffee"),__('Thanks for using this plugin! You\'ve installed this plugin over a month ago. If it works and you are satisfied with the results, isn\'t it worth at least a coffee? <a href="%s">Buy me a coffee</a> help me to continue support and development of this <i>free</i> software! <a href="%s">Sure, no problem!</a>','sitemap')); ?> <a href="<?php echo $this->sg->GetBackLink() . "&amp;sm_donated=true"; ?>" style="float:right; display:block; border:none; margin-left:10px;"><small style="font-weight:normal; "><?php _e('Sure, but I already did!', 'sitemap'); ?></small></a> <a href="<?php echo $this->sg->GetBackLink() . "&amp;sm_hide_note=true"; ?>" style="float:right; display:block; border:none;"><small style="font-weight:normal; "><?php _e('No thanks, please don\'t bug me anymore!', 'sitemap'); ?></small></a></p></strong>
				...
				?>
				<div class="updated">
					<strong><p><?php echo str_replace("%s",$this->sg->GetRedirectLink("rate"),__('Thanks for using this plugin! You\'ve installed this plugin some time ago. If it works and your are satisfied, why not <a href="%s">rate it</a> and <a href="%s">recommend it</a> to others? :-)','sitemap')); ?> <a href="<?php echo $this->sg->GetBackLink() . "&amp;sm_hide_works=true"; ?>" style="float:right; display:block; border:none;"><small style="font-weight:normal; "><?php _e('Don\'t show this anymore', 'sitemap'); ?></small></a></p></strong>
					<div style="clear:right;"></div>
				</div>
				<?php
			}
			...
			<form method="post" action="<?php echo $this->sg->GetBackLink() ?>">
				...
				?>
					...
					<?php if(!$snl): ?>
							...
							<?php $this->HtmlPrintBoxHeader('dm_donations',__('Buy Me Coffee:','sitemap'),true); ?>
								
								<script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="mikeirvine" data-color="#FFDD00" data-emoji=""  data-font="Cookie" data-text="Buy me a coffee" data-outline-color="#000" data-font-color="#000" data-coffee-color="#fff" data-font-color="#000"></script>
					...
					<?php
						...
						<div style="min-height:150px;">
							...
							<ul>
								<li>
									<?php echo sprintf(__('If you like the plugin, please <a target="_blank" href="%s">rate it 5 stars</a> or <a href="%s">Buy me a coffee</a> Thanks a lot! :)','sitemap'),$this->sg->GetRedirectLink('rate'),$this->sg->GetRedirectLink('buymecoffee')); ?>
								</li>
					...
					<ul>
						<li>
							...
							<small><?php_e('No registration required, but you can join the Google Webmaster Tools to check crawling statistics.','sitemap'); ?></small>
						</li>
						<li>
							...
							<small><?php_e('No registration required, but you can join the Bing Webmaster Tools to check crawling statistics.','sitemap'); ?></small>
						</li>
						<li>
					...
					<?php if(is_super_admin()): ?>
						...
						<ul>
							...
							<li>
								...
								<small><?php _e('Use this if your blog is in a sub-directory, but you want the sitemap be located in the root. Requires .htaccess modification.','sitemap'); ?></small>
							</li>
							<li>
								<label for="sm_b_html">
