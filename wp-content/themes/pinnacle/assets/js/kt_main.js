     ...
     // Gutenberg Gallery
		$('.wp-block-gallery').each(function(){
			...
			$( '.kb-gallery-ul:not( .kb-gallery-magnific-init )' ).each( function() {
				...
				$( this ).find( 'li.kadence-blocks-gallery-item a.kb-gallery-item-link:not(.kb-gallery-item-link)' ).magnificPopup( {
					type: 'image',
				...
				$( this ).find( '.kt-blocks-carousel .kb-slide-item:not(.slick-cloned) a.kb-gallery-item-link:not(.kb-gallery-item-link)' ).magnificPopup( {
					type: 'image',
					mainClass: 'mfp-kt-blocks kb-gal-light-filter-' + filter,
					gallery: {
						enabled: true,
