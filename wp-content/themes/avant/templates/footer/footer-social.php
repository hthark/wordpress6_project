	...
	<div class="site-footer-icons">
        <div class="site-container">
			...
			if( get_theme_mod( 'avant-social-tiktok' ) ) :
			    echo '<a href="' . esc_url( get_theme_mod( 'avant-social-tiktok' ) ) . '" target="_blank" title="' . esc_attr__( 'Follow Us on TikTok', 'avant' ) . '" class="footer-social-icon footer-social-tiktok"><i class="fab fa-tiktok"></i></a>';
			endif;
